...
public class SecurityPassMaker
{
  ...
  {
    if (support.GetType() == typeof(Security)) return "Security Team Member Priority Personnel";
    else if (support is Staff staff) return staff.Title;
    else if (support is TeamSupport) return "Too Important for a Security Pass";
    else return "";
  }
}

/**** Please do not alter the code below (generated by Exercism) ****/
