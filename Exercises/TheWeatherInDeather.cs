  ...
  public Outlook LongTermOutlook
  {
    get
    {
      if (reading.WindDirection == WindDirection.Southerly
          ...
          && reading.Temperature > 20) return Outlook.Good;
      if (reading.WindDirection == WindDirection.Northerly) return Outlook.Cool;
      if (reading.WindDirection == WindDirection.Easterly
          && reading.Temperature <= 20) return Outlook.Warm;
      if (reading.WindDirection == WindDirection.Westerly) return Outlook.Rainy;
